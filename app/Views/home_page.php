    ...
    <section>
        <div class="d-grid monthly-donation">
            ...
            <div style="margin: 2em auto;display:flex;justify-content: space-between;flex-direction: row;" class="justify-content-between  donation-card">
                ...
                <div class="card w-100 text-center" style="opacity: 0.8;transform: scale(.8, .8);width:100%">
                ...
                <div class="card w-100 text-center" style="opacity: 1;width:100%">
                ...
                <div class="card w-100 text-center" style="opacity: 0.6;transform: scale(.8, .8);width:100%">
    ...
    <div class="container mt-5 pt-5 mb-3">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class=" mb-5 ">
                    KWETA is the Kwara State Education Transformation
                    Agenda serving as a communique from the Kwara Education Futures Summit
                    held in Ilorin, Kwara state capital, on the 5th of August, 2021.
                </p>
            ...
            <div class="container mt-5 pt-5">
                ...
                <div class="row ">
                    <div class="col-sm-12 col-lg-6">
                        <h3 class="h3 text-success">Partnership</h3>
                        <p class="p mt-3">
                            Prioritisation of Public and Private Partnerships to provide
                            and support quality education has led the following current
                            and prospective partners to take an interest in the education
                            of children in Kwara State. They have also taken up
